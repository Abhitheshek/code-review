...
const App = () => {
  ...
  <div className='left relative md:h-full h-[48vh] bg-gray-900 rounded-lg m-0 overflow-auto'>
  ...
  <div className='right md:h-full h-[48vh] bg-white rounded-lg p-4 overflow-auto'>
